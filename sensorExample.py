...
AREF = 3.3 # volt
DEFAULT_OUTPUT_VOLTAGE = 5/2  # sensor vcc = 5 V, but a voltage divider is used to get 1.65 V from 2.5 V for the sensor out pin
ERROR = 0.26 # ampere
# declaration of pin objects
analogInputPin = ADC(27) # only one positional argument
                          # which is pin id
